...
<section class="sec1 pt-const2">
    ...
    <div class="container">
        ...
        <div class="mt-5 inner-container2 mx-auto">
            ...
            <div class="mt-3">
                債務重組計劃（DRP）是一種簡單的債務重組解決方案，爾聯在經驗豐富的執業會計師/律師獨立分析閣下的個案後,以高透明度的費用令你重新獲得財務自由。
            </div>
            <div class="gold">DRP是一種相對快速，可行且簡單的解決方案，無需任何法律程序。我們的專員將根據您的財務狀況設計還款時間表，並直接與債權人進行協調。
            </div>
        ...
        <div class="row gx-5 justify-content-center mt-6">
            ...
            <div class="col-lg-7 col-md-12 col-sm-12 col-12 position-relative gold-table-div-wrapper-col">
                ...
                <li class=" wow fadeInUp animated" style="opacity: 1; visibility: visible; animation-name: fadeInUp;">
                    ...
                    <div class="jiage">
                        ...
                        <div class="d-inline-block">
                            ...
                            <div>
                                <span class="gold">每月總節省利息：</span>$6,988-$1423 <span class="gold">=</span> $5,565
                            </div>
                            <div>
                                <span class="gold"> 每月還款金額：</span>$12,263 <span class="gold">減至</span> $7,488.28
                            </div>
                            <div class="little-flo-bottom"></div>
                        </div>
                    </div> -->
