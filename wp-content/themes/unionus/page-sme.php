    ...
    <div class="container">
        ...
        <div class="inner-container mx-auto mt-6">
            ...
            <div class="mt-6">
                ...
                <div class="mt-5 text-center">百分百擔保特惠貸款的申請最高金額為600萬港元，或者公司員工的每月薪金加每月租金乘以18的總和，以數值最低者為準。

                    <h2 class="gold text-center mt-5">例子一：</h2>
                    ...
                    <h2 class="gold text-center mt-5">例子二：</h2>
                    ...
                    <div class="mt-6">
                        ...
                        <div>由香港按證公司列出百分百擔保特惠貸款的主要統計數據，按證保險公司百分百擔保特惠貸款已批出28,000宗, 合供450億港元！ <br> <br>
                    ...
                    <div class="mt-5">事實上，香港有很多中小企業申請「百分百擔保特惠貸款」時，即使符合申請條件，他們還是很容易遇上各種困難，例如：
                    </div>
                ...
                <div class="mt-5">
                    ...
                    <div class="mt-5">我們會安排專人協助準備所需文件如商業登記、營運證明、營業數據等資料，並可快速為客戶配對合適銀行，提高申請成功率，加快整個申請過程，順利完成申請。
...
<section class="sec5 pt-const">
    ...
    <div class="contact-form-div">
        ...
        <div class="row">
            <div class="col-6">姓名：<input type="text" class="form-control" placeholder=""></div>
            <div class="col-6">聯絡電話：<input type="text" class="form-control" placeholder=""></div>
            <div class="col-6">電郵：<input type="text" class="form-control" placeholder=""></div>
            <div class="col-6"> 是否支援whatsapp？
