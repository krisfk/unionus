            ...
            <div class="mt-lg-5 mt-md-5 mt-sm-4 mt-4  text-center">
                ...
                <div class="mt-6">
                    ...
                    <div>由香港按證公司列出百分百擔保特惠貸款的主要統計數據，按證保險公司百分百擔保特惠貸款已批出28,000宗, 合供450億港元！ <br> <br>
                        ...
                        銀行亦拒絕了不少文件不齊全的申請案例，令到老闆們擔心申請不易。近期經濟下行，銀行審批貸款的要求比以前更高，不少中小企老闆心中會存有問號「我是否真的可以成功申請銀行貸款？」</div>
                </div>
            ...
            <div class="mt-lg-5 mt-md-5 mt-sm-4 mt-4 ">
                ...
                <div class="row mt-lg-5 mt-md-5 mt-sm-4 mt-4 ">
                    <div class="col-4 text-center">
                        <img class="sme-icon"
                            src="https://unionus.com.hk/wp-content/themes/unionus/assets/images/sme-icon-1.png" alt="">
                    ...
                    <div class="col-4 text-center">
                        <img class="sme-icon"
                            src="https://unionus.com.hk/wp-content/themes/unionus/assets/images/sme-icon-2.png" alt="">
                        <div class="big-size mt-4">
                            加快文件處理速度
                    ...
                    <div class="col-4 text-center">
                        <img class="sme-icon"
                            src="https://unionus.com.hk/wp-content/themes/unionus/assets/images/sme-icon-3.png" alt="">
                        <div class="big-size mt-4">
                            增加成功申請的機會
                        </div>
                    </div>
