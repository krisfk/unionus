    ...
    function f(t, e) {
        return (
            ...
            (function(t, e) {
                ...
                try {
                    for (
                        var r, l = t[Symbol.iterator](); !(s = (r = l.next()).done) &&
                        (i.push(r.value), !e || i.length !== e); s = !0
                    );
                } catch (t) {
                    (n = !0), (o = t);
                } finally {
                        ...
                        (t.scrollBy = function() {
                            void 0 !== arguments[0] &&
                                (a(arguments[0]) ?
                                    ...
                                    p.call(
                                        t,
                                        e.body, ~~arguments[0].left + (t.scrollX || t.pageXOffset), ~~arguments[0].top + (t.scrollY || t.pageYOffset)
                                    ));
                        }),
                ...
                (null !== e ? e : this).Lethargy = (function() {
                    function t(t, e, i, s) {
                        ...
                        (this.lastUpDeltas = function() {
                            var t, e, i;
                            for (
                                i = [], t = 1, e = 2 * this.stability; 1 <= e ? t <= e : t >= e; 1 <= e ? t++ : t--
                            )
                                i.push(null);
                            return i;
                        }.call(this)),
            ...
            return (
                i(n, [{
                                        ...
                                        Object.entries(this.sections).forEach(function(i) {
                                            ...
                                            n.persistent ||
                                                ...
                                                ('horizontal' === t.direction ?
                                                    t.transform(
                                                        n.el, -t.instance.scroll[t.directionAxis],
                                                        0
                                                    ) :
                                                    t.transform(
                                                        n.el,
                                                        0, -t.instance.scroll[t.directionAxis]
                                                    ),
                                                    n.inView ||
                                                    ((n.inView = !0),
                            ...
                            Object.entries(this.parallaxElements).forEach(function(r) {
                                ...
                                a.sticky &&
                                    (c = a.inView ?
                                        ...
                                        a.bottom - a.top + window.innerHeight), !1 !== c &&
                    ...
                    },
                    {
                        ...
                        value: function(t, e) {
                            this.instance = o(
                                o({}, this.instance), {}, { scroll: { x: t, y: e }, delta: { x: t, y: e }, speed: 0 }
                            );
                        },
                    },
                    {
